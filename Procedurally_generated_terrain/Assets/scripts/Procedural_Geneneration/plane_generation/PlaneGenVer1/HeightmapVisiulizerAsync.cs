...
public class HeightmapVisiulizerAsync : MonoBehaviour
{
    ...
    [SerializeField] private bool DebugValidate;
    ...
    public class CurveSettings
    {
        ...
        public NoiseLayerSettings layer3Settings;
    ...
    public async void HeightVizWrapperFunction()
    {
        ...
        //2d noise map 
        Task<float[,]> taskMapMain = Task.Run(() => _heightmapGenerator.MapGenerator(n, n, settingsCurve1Scale, curveSettings.layer1Settings.octaves,
            curveSettings.layer1Settings.persistance, curveSettings.layer1Settings.lacunarity, xMove * 1 / 100, yMove * 1 / 100, seed));
 
        //curve2 weight map
        Task<float[,]> taskCurve2WeightMap = Task.Run(() => _heightmapGenerator.MapGenerator(n, n, settingsCurve2Scale, curveSettings.layer2Settings.octaves,
            curveSettings.layer2Settings.persistance, curveSettings.layer2Settings.lacunarity, xMove * 1 / 100, yMove * 1 / 100, 98));
        
        //curve3 weight map
        Task<float[,]> taskCurve3WeightMap = Task.Run(() => _heightmapGenerator.MapGenerator(n, n, settingsCurve3Scale, curveSettings.layer3Settings.octaves,
            curveSettings.layer3Settings.persistance, curveSettings.layer3Settings.lacunarity, xMove * 1 / 100, yMove * 1 / 100, 100));
        ...
        float height3, float curve3Weight, float amplificationScale)
    {
        ...
        float weight2 = AmplifyAndNormalize(curve2Weight, curveSettings.layer2Settings.amplificationConstant);
        float weight3 = AmplifyAndNormalize(curve3Weight, curveSettings.layer3Settings.amplificationConstant);
